...
import org.example.remedy.domain.dropping.application.exception.DroppingAlreadyExistsException;
...
@Repository
public class DroppingRepositoryImpl implements DroppingRepository {
